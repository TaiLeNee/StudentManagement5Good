...
namespace StudentManagement5Good.Migrations
{
    ...
    [Migration("20251029063752_Add_WorkflowStatus_To_KetQuaDanhHieu")]
    partial class Add_WorkflowStatus_To_KetQuaDanhHieu
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StudentManagement5GoodTempp.DataAccess.Entity.KetQuaDanhHieu", b =>
                {
                    ...
                    b.Property<string>("TrangThaiWorkflow")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasColumnName("trangThaiWorkflow");
